...
namespace Shielded.Gossip.Mergeables
{
    ...
    {
        /// <summary>
        /// Wraps the value in a <see cref="VecVersioned{T}"/> with the given version vector.
        /// </summary>
        ...
        /// <summary>
        /// Wraps the value in a <see cref="VecVersioned{T}"/> with a new version vector. To produce new
        ...
        /// in a <see cref="VecVersioned{T}"/> to add a version vector. In case of conflict we return all
